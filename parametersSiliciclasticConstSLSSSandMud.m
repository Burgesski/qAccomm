function params = parametersSiliciclasticConstSLSSSandMud(modelName, plotFlag)
    ...
    sedSupplyIncrementAmplitude = 0; % 0 for simplest model, or 10.0E5 for interesting sed supply forcing;
    ...
    eustasyAmplitude = 0; % zero to peak oscillation size, in m 10m for SL forced, zero for unforced
    ...
    eustaticIncrementAmplitude = 0; % Zero for simplest model, 1 for Sl-forced model
    for t = 2:params.totalChrons
